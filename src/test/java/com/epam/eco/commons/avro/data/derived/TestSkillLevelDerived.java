...
public class TestSkillLevelDerived extends org.apache.avro.specific.SpecificRecordBase implements org.apache.avro.specific.SpecificRecord {
  private static final long serialVersionUID = 6242696260729160636L;
  ...
  private static final BinaryMessageEncoder<TestSkillLevelDerived> ENCODER =
      new BinaryMessageEncoder<TestSkillLevelDerived>(MODEL$, SCHEMA$);

  private static final BinaryMessageDecoder<TestSkillLevelDerived> DECODER =
      new BinaryMessageDecoder<TestSkillLevelDerived>(MODEL$, SCHEMA$);

  /**
   * Return the BinaryMessageEncoder instance used by this class.
   * @return the message encoder used by this class
   */
  public static BinaryMessageEncoder<TestSkillLevelDerived> getEncoder() {
    return ENCODER;
  }
   ...
   */
  public static BinaryMessageDecoder<TestSkillLevelDerived> getDecoder() {
    return DECODER;
  }
   ...
   */
  public static BinaryMessageDecoder<TestSkillLevelDerived> createDecoder(SchemaStore resolver) {
    return new BinaryMessageDecoder<TestSkillLevelDerived>(MODEL$, SCHEMA$, resolver);
  }

  /**
   * Serializes this TestSkillLevelDerived to a ByteBuffer.
  ...
  /**
   * Deserializes a TestSkillLevelDerived from a ByteBuffer.
   * @param b a byte buffer holding serialized data for an instance of this class
   * @return a TestSkillLevelDerived instance decoded from the given buffer
   * @throws java.io.IOException if the given bytes could not be deserialized into an instance of this class
   */
  public static TestSkillLevelDerived fromByteBuffer(
  ...
  @SuppressWarnings("unchecked")
  private static final org.apache.avro.io.DatumWriter<TestSkillLevelDerived>
    WRITER$ = (org.apache.avro.io.DatumWriter<TestSkillLevelDerived>)MODEL$.createDatumWriter(SCHEMA$);
  ...
  @SuppressWarnings("unchecked")
  private static final org.apache.avro.io.DatumReader<TestSkillLevelDerived>
    READER$ = (org.apache.avro.io.DatumReader<TestSkillLevelDerived>)MODEL$.createDatumReader(SCHEMA$);
